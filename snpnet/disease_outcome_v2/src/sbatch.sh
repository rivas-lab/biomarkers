...
phe_file="@@@@@@/users/ytanigaw/repos/rivas-lab/biomarkers/snpnet/disease_outcome_v2/phe/phe.tsv"
...
family="binomial"
out_dir_root="@@@@@@/users/ytanigaw/repos/rivas-lab/biomarkers/snpnet/disease_outcome_v2/out"
