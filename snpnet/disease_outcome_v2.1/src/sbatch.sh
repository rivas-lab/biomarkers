...
wrapper="@@@@@@/users/ytanigaw/repos/rivas-lab/PRS/helper/snpnet_wrapper.v2.1.sh"

cores=$( cat $0 | egrep '^#SBATCH --cores='  | awk -v FS='=' '{print $NF}' )
mem=$(   cat $0 | egrep '^#SBATCH --mem='    | awk -v FS='=' '{print $NF}' )

# snpnet_dir="@@@@@@/software/snpnet"
snpnet_dir="@@@@@@/users/ytanigaw/repos/rivas-lab/snpnet"

genotype_pfile="/scratch/users/ytanigaw/tmp/snpnet/geno/array_combined/ukb24983_cal_hla_cnv"
phe_file="@@@@@@/users/ytanigaw/repos/rivas-lab/biomarkers/snpnet/disease_outcome_v2.1/phe/phe.tsv"
...
family="binomial"
out_dir_root="@@@@@@/users/ytanigaw/repos/rivas-lab/biomarkers/snpnet/disease_outcome_v2.1/out"
