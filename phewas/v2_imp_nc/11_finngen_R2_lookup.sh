...
finngen_var_ids="${res_dir}/ukb24983_imp_v3.nc.phewas.hits.ld.gwascatalog.novel.finngen_vars.lst"
finngen_R2_extracted="${res_dir}/ukb24983_imp_v3.nc.phewas.hits.ld.gwascatalog.novel.finngen.R2.tsv"
...

{
    ...
    | parallel -k "tabix ${finngen_R2_master} {}" 
